...
export default function TechArchitecture() {
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <div className="relative z-10 w-full max-w-7xl mx-auto mb-16 md:mb-24 text-center md:text-left flex flex-col md:flex-row items-center md:items-end justify-between gap-8">
        <div>
          ...
          <h2 className="text-[3rem] md:text-[5rem] lg:text-[6rem] font-abeezee font-light leading-[1] text-[#F5F0E6] uppercase tracking-tighter">
            THE STACK <br className="hidden md:block" />
      ...
      {/* Bento Grid */}
      <div className="relative z-10 w-full max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
        
        {/* Frontend - Col Span 2 */}
        <div className="group flex flex-col justify-between col-span-1 md:col-span-2 bg-[#0A0A0A] border border-[#151515] hover:border-[#9E8557]/40 p-8 md:p-12 transition-colors duration-700 rounded-sm relative overflow-hidden min-h-[350px]">
          {/* Background Glow */}
        ...
        {/* AI - Col Span 1 */}
        <div className="group flex flex-col justify-between col-span-1 bg-[#0A0A0A] border border-[#151515] hover:border-[#F5F0E6]/30 p-8 md:p-12 transition-colors duration-700 rounded-sm relative overflow-hidden min-h-[350px]">
        ...
        {/* Data - Col Span 1 */}
        <div className="group flex flex-col justify-between col-span-1 bg-[#0A0A0A] border border-[#151515] hover:border-[#858585]/40 p-8 md:p-12 transition-colors duration-700 rounded-sm relative overflow-hidden min-h-[350px]">
        ...
        <div className="group flex flex-col justify-between col-span-1 md:col-span-2 bg-[#050505] border border-[#151515] hover:border-[#333] p-8 md:p-12 transition-colors duration-700 rounded-sm relative overflow-hidden min-h-[350px]">
